    ...
    <header className="w-full bg-white border-b border-[#e2e8f0] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          <Link to="/" className="text-2xl font-bold tracking-tight text-[#1a1b22] hover:text-[#d32f2f] transition-colors">
            Resumix
          </Link>
          <nav className="hidden md:flex items-center gap-6 text-sm text-[#5d5e61] font-medium">
            <Link to="/dashboard" className="text-[#1a1b22] hover:text-[#d32f2f] transition-colors">
              Dashboard
            </Link>
            ...
            {apiDocsUrl && (
              <a href={apiDocsUrl} target="_blank" rel="noreferrer" className="hover:text-[#d32f2f] transition-colors">
                API Docs
              </a>
            )}
          </nav>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-[#1a1b22] font-medium">
            <div className="w-8 h-8 rounded-full bg-[#f1f5f9] border border-[#e2e8f0] flex items-center justify-center text-[#d32f2f] font-bold">
